...
(1, 'Welcome 2', 'Tempore in voluptatibus laborum illum. Labore vitae cumque quasi odio cum nihil dolor. Perferendis sed quae amet illo vel.', 1, '2019-09-06 00:13:22', '2019-09-18 05:07:55');
...
(1, 'Site Name', 'sitename', 'Netzone', '2019-09-12 00:21:06', '2019-09-12 00:28:57'),
...
(18, 'Domain', 'domain', '.netzone.nz', '2019-09-19 10:54:04', '2019-09-19 11:21:58');
...
CREATE TABLE `users` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `role` enum('client','administrator') COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(75, 'Anonymous', 'ava@tomahawk.co.nz', NULL, '$2y$10$18310LWgZdrRo9WJQthzP.mpabgW.gESjG87Km8Nuc3JhPv0kQ2ES', NULL, NULL, NULL, NULL, NULL, 'test about 123', '1572344575.jpg', NULL, '32fuB9b6ezzJtH0CfWhDVwH9yDEAZ9Wo7viW1ji1gZUGMiW1vyUMaXFyYMSr', 1, '2019-09-07 14:50:54', '2019-10-28 21:23:18', 'administrator'),
(76, 'Karen Anne', 'karen@test.com', NULL, '$2y$10$C7ibcSsy3M39Vts2vEnw1u0R5jZAxWc5SW3.I5Rx.w.f6ABQvWufm', NULL, NULL, NULL, NULL, NULL, 'test about test', '1568933409.jpg', NULL, NULL, 1, '2019-09-19 10:50:30', '2019-09-19 10:50:30', 'client');
